...
export default function ProductDetailsPage() {
  return (
    <Paper
      sx={{ margin: 2, padding: 3, display: "flex", flexDirection: { xs: "column", md: "row" } }}
    >
      ...
      <Box>
        ...
        <Typography paragraph marginTop={2} fontSize={18}>
          ...
          explicabo doloremque dolorum quia natus dolore reiciendis saepe fugiat, accusantium, quod
          nobis ratione iusto molestiae corporis sapiente sed? Lorem ipsum dolor sit, amet
          consectetur adipisicing elit. Quis voluptate nobis sequi similique iure. Laboriosam sit
          rem quia, ducimus esse, expedita minus perferendis dicta aut fugiat quaerat, amet laborum
          modi.
        </Typography>
      </Box>
      <ContactTable />
